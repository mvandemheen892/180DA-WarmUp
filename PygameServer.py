...
#client.publish("ece180d/rockpaperscissors/servertoplayer1","cleartosend",qos=1)
#client.publish("ece180d/rockpaperscissors/servertoplayer2","cleartosend",qos=1)
...
while True: 
  ...
  if result == 0:
    ...
    client.publish("ece180d/rockpaperscissors/servertoplayer2","Player 1 put " + player1move + ", you lost!",qos=1)
  elif result == 2:
